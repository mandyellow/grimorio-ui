...
stories.add(
  'Range date',
  withState({ startDate: undefined, endDate: undefined })(({ store }) => {
...
stories.add(
  'Single Date',
  withState({ singleDate: undefined })(({ store }) => {
...
stories.add(
  'With default values',
  ``,
  withState({ startDate: moment().subtract(7, 'days'), endDate: moment() })(({ store }) => {
    const handleClick = () => {
